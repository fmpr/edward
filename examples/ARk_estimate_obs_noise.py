...
class ARModel:
    ...
    def log_prob(self, xs, zs):
        ...
        log_prior += invgamma.logpdf(sigma, self.a, self.b)
        ...
        log_lik = tf.reduce_sum(norm.logpdf(tf.transpose(y), x, sigma), 1)
...
inference.run(n_iter=3000, n_samples=300, n_print=100)
