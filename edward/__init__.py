...
from .util import cumprod, digamma, dot, get_dims, get_session, hessian, kl_multivariate_normal, lbeta, lgamma, log_sum_exp, logit, multivariate_rbf, rbf, set_seed, softplus
